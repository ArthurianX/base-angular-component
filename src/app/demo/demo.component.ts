...
export class DemoComponent implements OnInit {
  ...
  @ViewChild('userPhone0', { static: true }) userPhone0: ElementRef;
  @ViewChild('userPhone1', { static: true }) userPhone1: ElementRef;
  @ViewChild('userPhone2', { static: true }) userPhone2: ElementRef;
